...
function cs_front_scripts_enqueue() {
  ...
  // wp_enqueue_style('screen', get_template_directory_uri() . '/ressources/tags/1.0.2/css/screen.css');
   wp_enqueue_script('korrigan', get_template_directory_uri() . '/ressources/js/korrigan.js', '', '', true);
  // wp_enqueue_script('korrigan', get_template_directory_uri() . '/ressources/tags/1.0.2/js/korrigan.min.js', '', '', true);
}
