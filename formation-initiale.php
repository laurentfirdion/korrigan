<?php
//Template Name: Formation initiale
   ...
   <div class="panel panel-default">
    ...
    <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFive">
      <div class="panel-body">
        <?php the_field('textprogrammepro5'); ?>
         ...
         <?php 
        $value1 = get_field('programmepro6');
        if(isset($value1[0])){ ?>    
      <div class="panel panel-default">
    ...
    <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix">
      <div class="panel-body">
        ...
        <?php 
        $value2 = get_field('programmepro7');
        if(isset($value2[0])){ ?>    
      <div class="panel panel-default">
    ...
    <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
      <div class="panel-body">
        ...
        <?php 
        $value3 = get_field('programmepro8');
        if(isset($value3[0])){ ?>    
      <div class="panel panel-default">
    ...
    <div id="collapseThirteen" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThirteen">
      <div class="panel-body">
        <?php the_field('textprogrammegene5'); ?>
         ...
         <?php 
        $value1 = get_field('programmegene6');
        if(isset($value1[0])){ ?>    
...
$defaults = array(
	'theme_location'  => 'Menu formation initiale',
	'menu'            => '',
	'container'       => '',
	'container_class' => '',
	'container_id'    => '',
